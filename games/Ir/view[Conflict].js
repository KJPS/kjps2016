var renderer = PIXI.autoDetectRenderer(view_width, view_height,{backgroundColor : 0x1099bb});
...
function setup()
{
  ...
  floor=new_sprite(-300,-300,0,0,'sprites/enviroment/environment-finished.png');
  ...
  //750, 750
  player=new_sprite(200,200,0.5,0.5,'sprites/characters/player.png');
...
///
  ...
  for (var i in enemies)
  {
    ...
    enemies[i].rotation = (direction-(direction-direction_to_player)/2);
